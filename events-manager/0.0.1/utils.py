...
def discover_events(env, messages, processed_results):
    system_prompt = """
    You're an AI assistant and your mission is to find intersting events based on user preferences and objective.
    
    Find interesting events happening near [Location] between [Start Date] and [End Date] that match the following user profile:

    Age: [Age]

    Interests: [List of interests]

    Preferred event type(s): [e.g., concerts, networking, workshops, outdoor activities]

    Budget: [Free / Low / Medium / High]

    Social preferences: [Solo / Group / Family-friendly / Networking-focused]
    Only include events that are popular, unique, or well-rated.
    """
